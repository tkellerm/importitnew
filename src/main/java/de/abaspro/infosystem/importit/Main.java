        ...
        try {
            if (dataListNotEmpty()) {
                for (Data data : dataList) {
                    ...
                    if (!(errorReport.isEmpty() && infosys.getYshowonlyerrorline()) || !infosys.getYshowonlyerrorline()) {
                        ...
                        if (data.getTypeCommand() == null) {
                            ...
                            row.setYsel(Util.getMessage("main.load.table.type.command", data.getTypeCommand(), dataList.indexOf(data)));
                        }
                ...
                if (infosys.getYdatafile().isEmpty()) {
                    new TextBox(ctx, Util.getMessage("main.exception.title"), Util.getMessage("main.err.load.table.no.file")).show();
                } else {
                    new TextBox(ctx, Util.getMessage("main.exception.title"), Util.getMessage("main.err.load.table.no.structure.check")).show();
                }
            }
        } catch (Exception e) {
            showErrorBox(ctx, e.getMessage());
...
//            edpProcessing.checkDataListStructure(dataList);
            ...
            new TextBox(ctx, Util.getMessage("main.structure.check.box.title"), Util.getMessage("main.structure.check.box.message")).show();
